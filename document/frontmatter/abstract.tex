...
consuming very low power. Faced with such devices, the possibility of running
\ac{DNN} seems questionable, but with the right strategies, it is possible to leverage
...
on inference latency and the network's energy consumption. %TODO adicionar resultados
