...
Throughout this dissertation, we have presented \ac{DisRUPT}, an agnostic testbed 
...
distribuition, estabilished routes and input data.
...
the distributed inference process, and the importance of minimizing their occurence,
...
\begin{itemize}
    \item \textbf{Hypothesis: } \textit{"Is it possible to create a reliable tool to 
        ...
        even if limited in supported model architectures and width.
...
Even though the contibutions of this dissertation reached the expected goals, the work
...
more \ac{DNN} architectures, such as recurrent and attention layers, therefore
enabling the partitioning of more complex, and capable models. Likewise, the
...
Additionally, the testbed can be extended to support more device types, such as
\acp{TPU}, \acp{NPU}, and \acp{GPU}, allowing the evaluation of a more diverse range
of strategies and deployment scenarios, to further explore the potential of
...
network conditions and the available resources, which can improve the quality of
collected data, that will be closer to a real world scenario, and therefore, more
reliable and useful for future research in this field.