...
without risking the loss of a big part of the desired efficiency. In this subsection
...
\begin{description}[style=unboxed, leftmargin=1cm, font=\bfseries]
    ...
    feature tensor to be wirelessly transmitted to an edge server. The result is
...
& 
    Load balancing approach for heterogeneous devices.
\\
\hline
\end{tabularx}
\vspace{2mm}
