...
\begin{description}[style=unboxed, leftmargin=1cm, font=\bfseries]
    ...
    between end and edge devices. The work elaborates a special algorithm that
    ...
    experience memory sampling. The network also makes use of ZeroMQ\footnote{\url{https://zeromq.org/}} 
...
between devices. These methods can be effective in scenarios where the network
...
inference tasks. Some focusing on model partitioning strategies, to maximize
...
between Model Bi-Partitioning and Model Local Partitioning approaches. The former
...
partitioned model is deployed locally, to a collection of devices closer to the
far-edge layer.

Furthermore, we have analysed the network management strategies employed by
the reviewed frameworks, categorizing them into heuristical and reinforcement
