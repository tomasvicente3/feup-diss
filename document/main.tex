...
\copyrightnotice{Tomás Alexandre Soeiro Vicente, \the\year{}}
...
\supervisor{Second Supervisor}{Fernando Rego}
...
\committeemember{President}{Prof.\ Rui Pinto}
\committeemember{Examiner}{Prof.\ Luís Moutinho}
\committeemember{Member}{Prof.\ Luís Almeida}
...
% \appendix 
%TODO layer-per-layer information (tensor shapes, output size, etc)
%TODO submodel energy profile
